...
// defino los pines como entradas Analogicas
#define adc_1 3
#define adc_2 4
#define adc_3 5
#define adc_4 6
...
// defino Led de verificacion de entradas Digitales
#define Led 2

void setup() {
  // Iniciamos la comunicacion serial a 115200 b/s
  Serial.begin(115200);
  ...
  // Configuramos las entradas digitales como interrucciones
